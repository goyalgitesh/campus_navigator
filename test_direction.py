...
model = load_model("../campus-navigator Env/direction/direction_model.h5")

# Load the tokenizer
with open('../campus-navigator Env/direction/tokenizer.pickle', 'rb') as handle:
    tokenizer = pickle.load(handle)

# Load the direction labels
with open('../campus-navigator Env/direction/direction_labels.pickle', 'rb') as handle:
